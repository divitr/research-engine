...
<div class="modal" class:modal-open={usModalOpen}>
  <div class="modal-box border border-[#9387fa] w-11/12 max-w-5xl text-gray-400">
    ...
    <div class="divider my-1"></div>
    <div class="flex flex-row gap-4 mt-[9px]">
      <div class="flex flex-col items-center w-1/3 rounded-xl bg-neutral">
        <div class="avatar my-3">
          <div class="w-24 rounded-full">
            <img src="src/icons/jonathan-sq.png" alt="Jonathan DiPinto"/>
          </div>
        </div>
      ...
      <div class="flex flex-col items-center w-1/3 rounded-xl bg-neutral">
        <div class="avatar my-3">
          <div class="w-24 rounded-full">
            <img src="src/icons/divit-sq.png" alt="Divit Rawal"/>
          </div>
        </div>
        <div class="divider m-0 mb-1 mx-4"></div>
      ...
      <div class="flex flex-col items-center w-1/3 rounded-xl bg-neutral">
        <div class="avatar my-3">
          <div class="w-24 rounded-full">
            <img src="src/icons/shivane-sq.png" alt="Shivane Dadi" />
          </div>
        </div>
        <div class="divider m-0 mb-1 mx-4"></div>
    ...
    <!-- <p class="pt-1 py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p> -->
    <div class="modal-action mt-3">
